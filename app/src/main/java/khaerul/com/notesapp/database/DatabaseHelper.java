package khaerul.com.notesapp.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Functiom Get Count data in Table
    ...
    public int upadteNote(Note note) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        return db.update(Note.TABLE_NAME,
                values, Note.COLUMN_ID + " = ?", new String[]{
                        String.valueOf(note.getId())
                });
    }

    //Function Delete data in Database where id is Selected
